...
function CustomDataGrid(props: any) {
  ...
  // AS OF RIGHT NOW, I HARD-CODED THE ROLE-BASED AUTHENTICATION,
  // I HAVEN'T MIGRATED THE USER BASED FUNCTION FROM THE PREVIOUS ITERATION
  const [user] = useAuthState(auth);
  const role = user?.uid == "a3rojnoKlAXYabHrC7UZL2ZIhxA2" ? "Admin" : "Guest";
  ...
  function CustomToolbar() {
    ...
    return (
      ...
      >
        <GridToolbarQuickFilter sx={{ marginLeft: "8px", marginTop: "8px" }} />
        <Box
          sx={{
            display: "flex",
            gap: "8px",
  ...
  const actionColumns: GridColDef[] =
    enableEdit || enableDelete ? [...columns, actionField] : [...columns];
    ...
    <>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            <Box>
              To import data into the table, please store the data in a .csv
              file. Put the attribute name on the first row, seperated by
              semicolons(;) as such:{" "}
